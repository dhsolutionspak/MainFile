              ...
              <div className="team__slide">
                <Link href="/team-details">
                  ...
                  <div className="team__info">
                    <h4 className="team__member-name-6">Mudassir Jaleel</h4>
            ...
            <SwiperSlide>
              <div className="team__slide">
                <Link href="/team-details">
                  ...
                  />
                  <div className="team__info">
                    <h4 className="team__member-name-6">Mohsin Jaleel</h4>
                    <h5 className="team__member-role-6">Co Founder & COO</h5>
                  </div>
                </Link>
              </div>
            </SwiperSlide>
            ...
            <SwiperSlide>
              <div className="team__slide">
                <Link href="/team-details">
                  ...
                  />
                  <div className="team__info">
                    <h4 className="team__member-name-6">Jawad Muhiuudin</h4>
                    <h5 className="team__member-role-6">Head of MENA Region</h5>
                  </div>
                </Link>
              </div>
            </SwiperSlide>
            ...
            <SwiperSlide>
              <div className="team__slide">
                <Link href="/team-details">
                  ...
                  />
                  <div className="team__info">
                    <h4 className="team__member-name-6">Ganero Chille</h4>
                    <h5 className="team__member-role-6">Head of US Region</h5>
                  </div>
                </Link>
              </div>
            </SwiperSlide>
          ...
          <div className="row">
            <div className="col-xxl-12">
              <div className="sec-title-wrapper pt-130 pb-140 text-anim">
                ...
                <p>
                  A hybrid team with hybrid culture. More than 77 people,
